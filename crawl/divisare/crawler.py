...
from crawl.divisare import parsers as divisare_parsers
from crawl.divisare.auth import get_authenticated_session
from core.utils import RateLimiter, logger
...
def _refresh_session() -> bool:
    ...
    import os as _os
    from crawl.divisare.auth import do_login
