...
def run_eval(limit: int = None, skip_enrich: bool = False,
    ...
    if not skip_enrich:
        from agent_llm_parser import enrich_building as enrich_fn, prompt_version
        enrich_pv = prompt_version()
    if not skip_analyze:
        from agent_image_analysis import analyze_building as analyze_fn, prompt_version as pv_a
